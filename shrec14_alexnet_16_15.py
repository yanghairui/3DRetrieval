...
from dataset.shrec_2014 import shrec_view
...
parser.add_argument('--config', default='experiments/shrec_2014/model/alexnet/config.yaml')
...
for epoch_idx in range(config.MAX_EPOCH):
    ...
    if epoch_idx == 55:
        save_checkpoints(0, 0, epoch_idx, 'all')
